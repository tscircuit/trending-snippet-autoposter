export class PostManager {
  ...
  async postSnippet(snippet: Snippet): Promise<{ successes: number, failures: number }> {
    let successes = 0;
    let failures = 0;
    ...
    console.log(`[POST-MANAGER] Posting summary: ${successes} successes, ${failures} failures`);
